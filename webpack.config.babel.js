...
// basic configuration:
const title = 'RuMobile'
const baseUrl = 'plugins/rumobile/dist/'
...
let config = generateConfig(
  ...
  ...(ENV === 'production' || ENV === 'development' ? [
    ...
    //copyFiles({patterns: [{ from: 'init.js', to: 'init.js' }, { from: 'plugin.info', to: 'plugin.info' }]})
  ] : [
    /* ENV === 'test' */
